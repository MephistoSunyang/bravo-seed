        ...
        switch (this.expressionMap.queryType) {
            case "soft-delete":
                if (metadata.deleteColumn) {
                    updateColumnAndValues.push(this.escape(metadata.deleteColumn.databaseName) + " = 1");
                }
            ...
            case "restore":
                if (metadata.deleteColumn) {
                    updateColumnAndValues.push(this.escape(metadata.deleteColumn.databaseName) + " = 0");
                }
                if (metadata.deleteDateColumn) {
