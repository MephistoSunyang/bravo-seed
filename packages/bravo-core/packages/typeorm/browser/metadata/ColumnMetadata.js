...
var ColumnMetadata = /** @class */ (function () {
    ...
    function ColumnMetadata(options) {
        ...
        /**
         * Indicates if this column contains an entity delete flag.
         */
        this.isDelete = false;
        /**
        ...
        if (options.args.mode) {
            ...
            this.isDelete = options.args.mode === "delete";
        ...
        if (this.isDelete) {
            if (!this.type && options.connection.driver.mappedDataTypes.delete)
                this.type = options.connection.driver.mappedDataTypes.delete;
            if (!this.default)
                this.default = function () { return options.connection.driver.mappedDataTypes.deleteDefault; };
        }
