                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (subject.metadata.deleteColumn && subject.metadata.deleteColumn.propertyName) {
                                            partialEntity[subject.metadata.deleteColumn.propertyName] = true;
                                        }
                            ...
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        if (subject.metadata.deleteColumn && subject.metadata.deleteColumn.propertyName) {
                                            partialEntity[subject.metadata.deleteColumn.propertyName] = false;
                                        }
                                        if (subject.metadata.deleteDateColumn && subject.metadata.deleteDateColumn.propertyName) {
